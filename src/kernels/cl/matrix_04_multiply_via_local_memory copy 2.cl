...
///////////////////////////////
    ...
    const int globalRow = GROUP_SIZE_X*get_group_id(0) + row; // Row ID of C (0..M)
    const int globalCol = GROUP_SIZE_X*get_group_id(1) + col; // Col ID of C (0..N)
    ...
    for (int t=0; t<numTiles; t++) {
        ...
        Asub[col][row] = a[tiledCol*w + globalRow];
